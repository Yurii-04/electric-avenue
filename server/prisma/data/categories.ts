...
export const categories: Category[] = [
  ...
  // { id: 'c46', name: 'MSI', parentId: 'c12' },
  // { id: 'c47', name: 'Samsung', parentId: 'c12' },
  // { id: 'c48', name: 'Acer', parentId: 'c12' },
  // { id: 'c49', name: 'Gigabyte', parentId: 'c12' },
  // { id: 'c50', name: 'Asus', parentId: 'c12' },
  // { id: 'c51', name: 'Quad HD 2K (2560x1440)', parentId: 'c12' },
  // { id: 'c52', name: 'Ultra HD 4K (3840x2160)', parentId: 'c12' },
  // { id: 'c53', name: 'For gaming', parentId: 'c12' },
  // { id: 'c54', name: 'OLED monitors', parentId: 'c12' },
  // { id: 'c55', name: '144 Hz monitors', parentId: 'c12' },
  // { id: 'c56', name: 'Curved monitors', parentId: 'c12' },
  //
  // { id: 'c57', name: 'QLED', parentId: 'c13' },
  // { id: 'c58', name: '4K', parentId: 'c13' },
  // { id: 'c59', name: 'WI-Fi', parentId: 'c13' },
  ...
  // { id: 'c70', name: 'PlayStation', parentId: 'c17' },
  // { id: 'c71', name: 'Xbox', parentId: 'c17' },
  // { id: 'c72', name: 'Nintendo', parentId: 'c18' },
  // { id: 'c73', name: 'SteamDeck', parentId: 'c18' },
  // { id: 'c74', name: 'Games for Playstation', parentId: 'c19' },
  // { id: 'c75', name: 'Games for Xbox', parentId: 'c19' },
  // { id: 'c76', name: 'Games for Nintendo', parentId: 'c19' },
  { id: 'c77', name: 'Gamepads', parentId: 'c20' },

  { id: 'c80', name: 'Routers', parentId: 'c21' },
  { id: 'c81', name: 'Switches', parentId: 'c21' },

  // { id: 'c83', name: 'Upgrading and installing components', parentId: 'c22' },
  // { id: 'c84', name: 'PC / Laptop cleaning', parentId: 'c22' },
  // { id: 'c85', name: 'Software installation and data transfer', parentId: 'c22' },
  // { id: 'c86', name: 'Replacing thermal paste and cleaning the cooling system', parentId: 'c22', },
  // { id: 'c87', name: 'Cable routing inside the PC case', parentId: 'c22' },

  // { id: 'c88', name: 'Antivirus', parentId: 'c23' },
  // { id: 'c89', name: 'Operating system', parentId: 'c23' },
  // { id: 'c90', name: 'Office products', parentId: 'c23' },
];
